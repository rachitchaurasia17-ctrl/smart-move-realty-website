        ...
        <div className="hero-bottom hero-fade-late" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(255,255,255,0.18)", paddingTop: 22, gap: 20, flexWrap: "wrap" }}>
          <div>
            ...
            <div className="clash" style={{ fontSize: 16, letterSpacing: "-0.02em", color: "#ffffff", fontWeight: 500 }}>
              Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar
            </div>
          </div>
        ...
        <div className="principal-grid">
          <div>
            <div className="principal-frame">
              <img src="assets/sachdeva-about.jpg" alt="Smart Move Realty office interior" />
            </div>
...
function Reviews() {
  const all = [
    { name: "Aman Khurana",    initial: "A", stars: 5, time: "2 months ago", text: "Smart Move Realty closed our SCO purchase end-to-end. From paperwork to registry, every detail was handled with extraordinary discretion. The most professional agency in the region." },
    ...
    { name: "Sunita Puri",      initial: "S", stars: 5, time: "1 month ago", text: "Three transactions with Smart Move Realty now. Their word is genuinely their bond. Wouldn't dream of going elsewhere." },
    ...
    <section id="about" style={{ paddingTop: 100, paddingBottom: 60 }}>
      <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 56, alignItems: "flex-start" }}>
        <div className="about-photo-col" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 360, width: "100%", justifySelf: "start" }}>
          ...
          <a
            href="https://www.google.com/maps/search/?api=1&query=Smart%20Move%20Realty+Plot%20No.%20780%2C%20Sector%2082%2C%20Industrial%20Park%2C%20Sahibzada%20Ajit%20Singh%20Nagar"
            target="_blank" rel="noopener noreferrer"
            onClick={(e) => { e.preventDefault(); window.open("https://www.google.com/maps/search/?api=1&query=Smart%20Move%20Realty+Plot%20No.%20780%2C%20Sector%2082%2C%20Industrial%20Park%2C%20Sahibzada%20Ajit%20Singh%20Nagar", "_blank", "noopener,noreferrer"); }}
            className="gs-wrap"
          ...
          >
            ...
            <div style={{ position: "absolute", left: 16, right: 16, bottom: 14, color: "#f6f6f6", display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 12 }}>
              <div>
                ...
                <div className="clash" style={{ fontSize: 15, letterSpacing: "-0.02em", marginTop: 4, fontWeight: 600 }}>Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar</div>
              </div>
        ...
        <div>
          ...
          <p className="clash" style={{ fontSize: "clamp(24px, 3.6vw, 48px)", letterSpacing: "-0.035em", lineHeight: 1.15, margin: 0, fontWeight: 500 }}>
            Smart Move Realty is a <span className="serif-it">GMADA</span> empanelled and <span className="serif-it">RERA</span> registered firm specializing in residential, commercial and land mandates across the Mohali tri-city. Operating from Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar.
          </p>
        ...
        <div className="desk-grid">
          ...
          <div className="desk-card">
            ...
            <div className="desk-row">
              ...
              <div className="desk-row-v"><a href="mailto:info@smartmovegroup.in">info@smartmovegroup.in</a></div>
            </div>
            <div className="desk-row">
              <div className="desk-row-k">In person</div>
              <div className="desk-row-v">Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar</div>
            </div>
      ...
      <div className="container">
        ...
        <div className="foot-cols">
          <div>
            ...
            <ul className="foot-list">
              ...
              <li><a href="mailto:info@smartmovegroup.in">info@smartmovegroup.in</a></li>
              <li><span>Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar</span></li>
            </ul>
          </div>
          <div>
        ...
        <div className="foot-bottom">
          <div className="foot-mark">
            <Crown />
            <span>© 2026 Smart Move Realty · All rights reserved</span>
          </div>
      ...
      <div className="container">
        <div style={{ borderTop: "1px solid var(--ink-2)", paddingTop: 48, display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "flex-end" }}>
            ...
            <a href="mailto:info@smartmovegroup.in" className="uc" style={{ fontSize: 11, letterSpacing: "0.16em", marginTop: 8, borderBottom: "1px solid var(--ink)", paddingBottom: 4 }}>
              info@smartmovegroup.in
            </a>
          </div>
        </div>
      </div>
    ...
    <footer style={{ background: "var(--dark)", color: "rgba(246,246,246,0.6)", borderTop: "1px solid rgba(255,255,255,0.05)", marginTop: 40 }}>
      <div className="container" style={{ paddingTop: 72, paddingBottom: 40 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 56 }}>
          <div>
            ...
            <p style={{ marginTop: 20, fontSize: 14, lineHeight: 1.65, maxWidth: 300 }}>
              Real estate agency & property experts in the Mohali tri-city. GMADA/RERA accredited. Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar.
            </p>
          </div>
          ...
          <FooterCol head="Contact" links={[
            ...
            [<span><IconMail/> info@smartmovegroup.in</span>, "mailto:info@smartmovegroup.in"],
            [<span><IconPin/> Plot No. 780, Sector 82, Industrial Park, Sahibzada Ajit Singh Nagar</span>, "#"],
            [<span><IconInsta/> @smartmoverealty</span>, "#"],
            [<span><IconYouTube/> @smartmoverealty</span>, "#"],
          ]} />
        </div>
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          <div className="uc" style={{ fontSize: 10, letterSpacing: "0.18em" }}>© 2026 Smart Move Realty — All rights reserved</div>
...
function WhatsAppFab() {
  ...
  const text = encodeURIComponent("Hello Smart Move Realty — I would like to enquire about a property listing.");
  return (
    <a
